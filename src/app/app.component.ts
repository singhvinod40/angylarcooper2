...
@Component({
  selector: "app-root",
  template: `<h2> Events lists </h2>
  <hr>
  <div class="row">
  <div *ngFor="let event of event1" class="col-md-4">
  <app-event-list  [events]="event1" (eventClicked)="handleChildoutput($event)" ></app-event-list>
  </div></div>
